            ...
            <nav className="nav">
                ...
                <div>
                    <ul id="navbar">
                        ...
                        <li><a href="index.html">Become A Teacher</a></li>
